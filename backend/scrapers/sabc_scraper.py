"""SABC News scraper implementation."""
...
TOPIC_URLS = {
    "top": "https://www.sabcnews.com/sabcnews/",
    "opinion": "https://www.sabcnews.com/sabcnews/category/opinion/",
...
def scrape_article(url: str, topic: Optional[str] = None) -> Optional[dict]:
    """Scrape a single SABC News article."""
...
def scrape(topic: Optional[str] = None, known_urls: Optional[Set[str]] = None) -> list[dict]:
    """Scrape SABC listing pages and return normalized article dictionaries."""
    session = build_session()
