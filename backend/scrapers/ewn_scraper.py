...
TOPIC_URLS = {
    "latest": "https://www.ewn.co.za/latest",
    "local": "https://www.ewn.co.za/category/south-africa",
    "politics": "https://www.ewn.co.za/category/politics",
    "world": "https://www.ewn.co.za/category/world",
}
...
def scrape(topic: Optional[str] = None, known_urls: Optional[Set[str]] = None) -> list[dict]:
    """Scrape EWN listing pages and return normalized article dictionaries."""
    session = build_session()
